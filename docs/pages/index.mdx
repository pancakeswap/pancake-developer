        ...
        <section className="w-full py-12 md:py-24 lg:py-32">
          <div className="container grid gap-6 px-4 md:px-6 lg:grid-cols-[1fr_400px] lg:gap-12">
            ...
            <a href="/contracts/v4/overview">
              ...
              <a href="/apis/subgraph">
                <Card>
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      <h3 className="text-xl font-bold">API Update: all endpoints available</h3>
                      <div className="text-gray-500 dark:text-gray-400">
                        A full list of subgraph endpoints is now available for developers to use.
                      </div>
                    </div>
                  </CardContent>
                </Card>
