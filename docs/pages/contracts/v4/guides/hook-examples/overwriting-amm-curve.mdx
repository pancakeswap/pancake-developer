...
In this guide, we'll build a hook which  overwrite the default pricing curve by the AMM. This guide assume you have read [develop-a-hook](/contracts/v4/guides/develop-a-hook) guide.
...
1. A new protocol have a new stablecoin and would like to leverage PCS infrastructure to allow user to swap
between their stablecoin and USDC at 0 slippage.

2. This mimic the typical mint/redeem functionality available at many other protocols.

3. To keep this guide simple, there will not be any fee taken for the hook.
