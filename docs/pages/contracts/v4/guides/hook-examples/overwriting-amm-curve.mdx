...
In this guide, we'll build a hook which overwrites the default pricing curve by the AMM. This guide assume you have read [develop-a-hook](/contracts/v4/guides/develop-a-hook) guide.
...
2. This mimic the typical mint/redeem functionality available at other protocols.

3. To keep this guide simple, there will not be any fee from the hook.
