...
We'll utilize Universal Router from [v4-universal-router](https://github.com/pancakeswap/pancake-v4-universal-router) to handle swaps in v4.

<Callout type="info">
  This guide will be relocated to the Universal Router section after v4 is launched as it covers swapping processes for v2, v3, and StableSwap
</Callout>
...
- `command`: 
    - a 7 bit unique identifier. A list of commands can be found in [Commands.sol](https://github.com/pancakeswap/pancake-v4-universal-router/blob/main/src/libraries/Commands.sol) and this document.
...
This section document the list of commands and its input. A list of commands can be found in [Commands.sol](https://github.com/pancakeswap/pancake-v4-universal-router/blob/main/src/libraries/Commands.sol). 
...
<Callout type="warning">
  Do not permit or approve Universal Router over a v4 position or someone could use this command to decrease/burn your position.
...
<Callout type="warning">
  Do not permit or approve Universal Router over a v4 position or someone could use this command decrease your position.
...
For details on the parameters required for each swap type refer to [CLRouterBase.sol](https://github.com/pancakeswap/pancake-v4-periphery/blob/main/src/pool-cl/interfaces/ICLRouterBase.sol) for the concentrated liquidity pool and [IBinRouterBase](https://github.com/pancakeswap/pancake-v4-periphery/blob/main/src/pool-bin/interfaces/IBinRouterBase.sol) for the Bin pools.
