...
<Callout type="info">
  Before calling any of the functions below, do approve either NonFungiblePositionManager or SwapRouter to allow the periphery contract to transfer tokens.
</Callout>
