...
**Round 400: BNB Price Prediction**

Assume round starts at 12:00

1. [12:00 to 12:05] **Place Bet**: User bet **Bull** (price will go up) with **0.1 BNB**

2. [12:05 to 12:10] **Lock Phase**: At 12:05, check with chainlink oracle on BNB price to get lock price. Assume BNB at **850 USD per BNB**

3. [12:10] **Close Phase**: At 12:10, check with chainlink oracle on BNB price to get close price. Assume BNB at **860 USD per BNB**

4. **Result**: As close price 860 is larger than lock price 850, so **user's bull bet wins!** 🎉
