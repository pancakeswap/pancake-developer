...
Users earn additional CAKE rewards by providing liquidity to Infinity Pools listed at https://pancakeswap.finance/liquidity/pools?type=1. 
...
If you are a protocol interested in launching a farm using your own token as a reward, we encourage you to reach out to the PancakeSwap team to share your feedback. Implementation will be considered based on demand.
:::
